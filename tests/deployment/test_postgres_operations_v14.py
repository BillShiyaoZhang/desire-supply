...
V27_SCRIPT = ROOT / "deploy/postgres-backup-restore-v27.sh"
...
class PostgresOperationsV14Test(unittest.TestCase):
    ...
    def test_unversioned_operations_script_is_the_current_v27_alias(self) -> None:
        self.assertEqual(CURRENT_SCRIPT.read_bytes(), V27_SCRIPT.read_bytes())
