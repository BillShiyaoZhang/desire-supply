...
V27_FACTS = ROOT / "deploy/postgres-core-facts-v27.sql"
V25_FACTS_SHA256 = (
...
class PostgresOperationsV25Test(unittest.TestCase):
    ...
    def test_unversioned_facts_are_the_current_v27_alias(self) -> None:
        self.assertEqual(CURRENT_FACTS.read_bytes(), V27_FACTS.read_bytes())
