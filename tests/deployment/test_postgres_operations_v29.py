"""Static contracts for current-head v29 PostgreSQL operations assets."""
...
SCRIPT = ROOT / "deploy/postgres-backup-restore-v29.sh"
FACTS = ROOT / "deploy/postgres-core-facts-v29.sql"
OVERLAY = ROOT / "deploy/postgres-operations-v29.compose.yaml"
V26_FROZEN = {
...
class PostgresOperationsV29Test(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        cls.script = SCRIPT.read_text(encoding="utf-8")
        cls.facts = FACTS.read_text(encoding="utf-8")

    def test_v29_pins_all_six_schema_components(self) -> None:
    ...
    def test_every_matching_v1_v10_table_has_private_count_and_empty_gate(self) -> None:
    ...
    def test_v29_overlay_only_rebinds_operations_configs(self) -> None:
