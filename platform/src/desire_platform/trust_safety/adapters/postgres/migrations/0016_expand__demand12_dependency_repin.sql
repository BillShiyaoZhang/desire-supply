-- Metadata-only Trust dependency repin from Demand0011 to Demand0012.
-- IAM0042 and every published Trust runtime ABI stay frozen.
...
BEGIN
    ...
    THEN
        RAISE EXCEPTION USING
            ERRCODE = '55000',
            MESSAGE = 'TRUST15_SCHEMA_CONTRACT_BASELINE_MISMATCH';
    END IF;
END
$trust15_contract_baseline$;
