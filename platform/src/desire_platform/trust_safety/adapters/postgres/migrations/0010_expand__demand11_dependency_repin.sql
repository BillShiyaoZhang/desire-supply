-- Metadata-only Trust dependency repin from reviewed Demand0010 to Demand0011.
...
BEGIN
    ...
    THEN
        RAISE EXCEPTION USING
            ERRCODE = '55000',
            MESSAGE = 'TRUST9_SCHEMA_CONTRACT_BASELINE_MISMATCH';
    END IF;
END
$trust9_contract_baseline$;
