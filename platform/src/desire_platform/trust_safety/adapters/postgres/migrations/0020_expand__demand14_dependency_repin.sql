-- Metadata-only Trust dependency repin from Demand0013 to Demand0014.
-- Every published Trust runtime ABI stays frozen.
...
BEGIN
    ...
    THEN
        RAISE EXCEPTION USING
            ERRCODE = '55000',
            MESSAGE = 'TRUST19_SCHEMA_CONTRACT_BASELINE_MISMATCH';
    END IF;
END
$trust19_contract_baseline$;
