-- Metadata-only publication of the existing actor-bound completed-case history.
-- Trust storage, SQL read programs, IAM0042, and Demand0012 stay frozen.
...
BEGIN
    SELECT
        ...
        COALESCE(
            bool_and(
                ...
                AND schema_head_version = 16
                AND min_app_compatible_version = 16
                AND max_app_compatible_version = 16
    ...
    THEN
        RAISE EXCEPTION USING
            ERRCODE = '55000',
            MESSAGE = 'TRUST16_SCHEMA_CONTRACT_BASELINE_MISMATCH';
    END IF;
END
$trust16_contract_baseline$;
