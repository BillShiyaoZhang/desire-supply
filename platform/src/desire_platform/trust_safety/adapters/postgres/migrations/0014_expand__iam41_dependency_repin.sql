-- Metadata-only Trust direct dependency repin from reviewed IAM0040 to
-- IAM0041. Demand0011 and its published transitive IAM0037 ABI stay frozen.
...
BEGIN
    ...
    THEN
        RAISE EXCEPTION USING
            ERRCODE = '55000',
            MESSAGE = 'TRUST13_SCHEMA_CONTRACT_BASELINE_MISMATCH';
    END IF;
END
$trust13_contract_baseline$;
