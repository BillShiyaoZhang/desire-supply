-- Metadata-only Trust direct dependency repin from reviewed IAM0038 to
-- IAM0039. Demand0011 and its published transitive IAM0037 ABI stay frozen.
...
BEGIN
    ...
    THEN
        RAISE EXCEPTION USING
            ERRCODE = '55000',
            MESSAGE = 'TRUST11_SCHEMA_CONTRACT_BASELINE_MISMATCH';
    END IF;
END
$trust11_contract_baseline$;
