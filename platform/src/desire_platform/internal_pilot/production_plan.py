...
def _validate_schema_contract_constants() -> None:
    if (
        ...
        or TRUST_SCHEMA_HEAD_VERSION != 23
        or TRUST_REQUIRED_IAM_SCHEMA_VERSION != 47
        or TRUST_REQUIRED_DEMAND_SCHEMA_VERSION != 15
        or MATCHING_SCHEMA_HEAD_VERSION != 10
        or MATCHING_REQUIRED_IAM_SCHEMA_VERSION != 47
    ):
