...
def _validate_schema_contract_constants() -> None:
    if (
        IAM_SCHEMA_HEAD_VERSION != 48
        or PROFILE_SCHEMA_HEAD_VERSION != 5
        or PROFILE_REQUIRED_IAM_SCHEMA_VERSION != 46
        or DEMAND_SCHEMA_HEAD_VERSION != 16
        or DEMAND_REQUIRED_IAM_SCHEMA_VERSION != 48
        or TRUST_SCHEMA_HEAD_VERSION != 24
        or TRUST_REQUIRED_IAM_SCHEMA_VERSION != 48
        or TRUST_REQUIRED_DEMAND_SCHEMA_VERSION != 16
        or MATCHING_SCHEMA_HEAD_VERSION != 11
        or MATCHING_REQUIRED_IAM_SCHEMA_VERSION != 48
    ):
